...
function AddCarInfoModal(props) {
      ...
      let saveCarInfo = async (event) => {
            ...
            if (Object.keys(errors).length === 0) {
                  try {
                        ...
                        let res = await axios.post("http://localhost:8085/admin/car/info", carData, {
                              headers: {
                                    'Authorization': token
                              }
                        })
                  ...
                  <Modal.Body>
                        <form onSubmit={saveCarInfo}>
                             ...
                             <div>
                              ...
                              <button onClick={()=>{validateData()}} className="btn btn-primary" >Add Car Details</button>
                        </form>
                  </Modal.Body>
                  <Modal.Footer>
